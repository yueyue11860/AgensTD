...
export interface ServerConfig {
  ...
  matchId: string
  tickRateMs: number
  /** Host timer cadence. It may only run faster than logical time in explicit non-production PVE E2E. */
  hostLoopIntervalMs: number
  /** Enables authenticated, production-forbidden E2E host-loop control. */
  pveE2eEnabled: boolean
  ...
  /** Whether this process also serves the built frontend shell. Disabled by default. */
...
function readNumber(name: string, fallback: number, bounds: NumberBounds = {}) {
