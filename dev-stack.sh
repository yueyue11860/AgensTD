...
BACKEND_DEV_COMMAND="${BACKEND_DEV_COMMAND:-env PORT=${BACKEND_PORT} AUTH_REQUIRED=true SERVE_FRONTEND=false SUPABASE_URL= SUPABASE_SERVICE_ROLE_KEY= PVP_STORE=memory PVE_REWARD_STORE=memory PVE_CHECKPOINT_STORE=memory pnpm dev}"
