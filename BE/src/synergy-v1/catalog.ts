import type { GeneralSynergyProfile, SynergyDefinition } from './types'

export const GENERAL_SYNERGY_PROFILES: readonly GeneralSynergyProfile[] = [
  {
    generalId: 'houyi',
    displayName: '后羿',
    glyphs: ['后', '羿'],
 ...
 */
export const MOON_PALACE_COMPANIONS: SynergyDefinition = {
  schemaVersion: 1,
