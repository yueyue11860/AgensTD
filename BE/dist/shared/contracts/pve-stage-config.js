 ...
 */
function buildTwentyWaveGlyphPools(glyphs) {
...
exports.PVE_STAGE_BY_LEVEL_ID = Object.freeze(Object.fromEntries(exports.PVE_STAGE_DEFINITIONS.map((definition) => [definition.levelId, definition])));
