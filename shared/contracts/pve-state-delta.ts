...
export function createPveMatchStatePatch(
  ...
  return {
    ...
    tutorialPaused: previous.tutorialPaused === next.tutorialPaused ? undefined : next.tutorialPaused,
...
export function applyPveMatchStatePatch(
  ...
  return {
    ...
    ...(patch.tutorialPaused === undefined ? {} : { tutorialPaused: patch.tutorialPaused }),
