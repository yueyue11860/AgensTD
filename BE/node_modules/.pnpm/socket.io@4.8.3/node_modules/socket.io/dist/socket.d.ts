...
import { AllButLast, DecorateAcknowledgements, DecorateAcknowledgementsWithMultipleResponses, DefaultEventsMap, EventNames, EventNamesWithAck, EventParams, EventsMap, FirstNonErrorArg, Last, StrictEventEmitter } from ".pnpm/socket.io@4.8.3/node_modules/socket.io/dist/typed-events";
import type { Client } from ".pnpm/socket.io@4.8.3/node_modules/socket.io/dist/client";
import type { Namespace } from ".pnpm/socket.io@4.8.3/node_modules/socket.io/dist/namespace";
...
import { DisconnectReason, Handshake, SocketReservedEventsMap } from ".pnpm/socket.io@4.8.3/node_modules/socket.io/dist/socket-types";
/**
 * `[eventName, ...args]`
 */
