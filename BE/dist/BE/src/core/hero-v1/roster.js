...
exports.GENERAL_ROSTER_BY_ID = exports.GENERAL_ROSTER = exports.GENERAL_IDS = void 0;
exports.validateGeneralRoster = validateGeneralRoster;
exports.getGeneralRosterEntry = getGeneralRosterEntry;
/**
 * 神将身份 ID 的唯一定义点。
 *
...
exports.GENERAL_ROSTER = [
    {
        generalId: exports.GENERAL_IDS.YANGJIAN,
        displayName: '杨戬',
        glyphs: ['杨', '戬'],
        quality: 'purple',
        profession: 'physical',
    ...
    {
        generalId: exports.GENERAL_IDS.NAZHA,
        displayName: '哪吒',
        glyphs: ['哪', '吒'],
        quality: 'purple',
        profession: 'physical',
    ...
    {
        generalId: exports.GENERAL_IDS.HOUYI,
        displayName: '后羿',
        glyphs: ['后', '羿'],
        quality: 'purple',
        profession: 'physical',
    ...
    {
        generalId: exports.GENERAL_IDS.SHA_WUJING,
        displayName: '沙悟净',
        glyphs: ['沙', '悟', '净'],
        quality: 'orange',
        profession: 'physical',
    ...
    {
        generalId: exports.GENERAL_IDS.ZHU_BAJIE,
        displayName: '猪八戒',
        glyphs: ['猪', '八', '戒'],
        quality: 'orange',
        profession: 'physical',
    ...
    {
        generalId: exports.GENERAL_IDS.YU_HUANG_DADI,
        displayName: '玉皇大帝',
        glyphs: ['玉', '皇', '大', '帝'],
        quality: 'red',
        profession: 'physical',
    ...
    {
        generalId: exports.GENERAL_IDS.LEI_GONG,
        displayName: '雷公',
        glyphs: ['雷', '公'],
        quality: 'purple',
        profession: 'magic',
    ...
    {
        generalId: exports.GENERAL_IDS.DIAN_MU,
        displayName: '电母',
        glyphs: ['电', '母'],
        quality: 'purple',
        profession: 'magic',
    ...
    {
        generalId: exports.GENERAL_IDS.ZHEN_YUANZI,
        displayName: '镇元子',
        glyphs: ['镇', '元', '子'],
        quality: 'orange',
        profession: 'magic',
    ...
    {
        generalId: exports.GENERAL_IDS.RU_LAI_FOZU,
        displayName: '如来佛祖',
        glyphs: ['如', '来', '佛', '祖'],
        quality: 'red',
        profession: 'magic',
    ...
    {
        generalId: exports.GENERAL_IDS.PU_TI_LAOZU,
        displayName: '菩提老祖',
        glyphs: ['菩', '提', '老', '祖'],
        quality: 'red',
        profession: 'magic',
    ...
    {
        generalId: exports.GENERAL_IDS.LIJING,
        displayName: '李靖',
        glyphs: ['李', '靖'],
        quality: 'purple',
        profession: 'summon',
    ...
    {
        generalId: exports.GENERAL_IDS.CHANG_E,
        displayName: '嫦娥',
        glyphs: ['嫦', '娥'],
        quality: 'purple',
        profession: 'summon',
    ...
    {
        generalId: exports.GENERAL_IDS.SUNWUKONG,
        displayName: '孙悟空',
        glyphs: ['孙', '悟', '空'],
        quality: 'orange',
        profession: 'summon',
    ...
    {
        generalId: exports.GENERAL_IDS.TAI_YI_ZHENREN,
        displayName: '太乙真人',
        glyphs: ['太', '乙', '真', '人'],
        quality: 'red',
        profession: 'summon',
    ...
    {
        generalId: exports.GENERAL_IDS.SHOU_XING,
        displayName: '寿星',
        glyphs: ['寿', '星'],
        quality: 'purple',
        profession: 'control',
    ...
    {
        generalId: exports.GENERAL_IDS.TANG_SANZANG,
        displayName: '唐三藏',
        glyphs: ['唐', '三', '藏'],
        quality: 'orange',
        profession: 'control',
    ...
    {
        generalId: exports.GENERAL_IDS.BAI_LONGMA,
        displayName: '白龙马',
        glyphs: ['白', '龙', '马'],
        quality: 'orange',
        profession: 'control',
    ...
    {
        generalId: exports.GENERAL_IDS.PI_LANPO,
        displayName: '毗蓝婆',
        glyphs: ['毗', '蓝', '婆'],
        quality: 'orange',
        profession: 'control',
    ...
    {
        generalId: exports.GENERAL_IDS.GUAN_YIN_PUSA,
        displayName: '观音菩萨',
        glyphs: ['观', '音', '菩', '萨'],
        quality: 'red',
        profession: 'control',
    ...
    {
        generalId: exports.GENERAL_IDS.TAI_SHANG_LAOJUN,
        displayName: '太上老君',
        glyphs: ['太', '上', '老', '君'],
        quality: 'red',
        profession: 'control',
...
const _GENERAL_ROSTER_EXACT_COUNT = exports.GENERAL_ROSTER.length;
void _GENERAL_ROSTER_EXACT_COUNT;
const qualityForGlyphCount = (glyphCount) => {
    if (glyphCount === 2)
        return 'purple';
    if (glyphCount === 3)
        return 'orange';
...
function validateGeneralRoster(roster = exports.GENERAL_ROSTER) {
    if (roster.length !== 21) {
    ...
    for (const entry of roster) {
        ...
        if (!expectedQuality || entry.quality !== expectedQuality) {
            throw new Error(`General ${entry.generalId} has invalid ${entry.glyphs.length}-glyph quality ${entry.quality}`);
        }
        professionCounts[entry.profession] += 1;
    }
    const expectedProfessionCounts = {
        physical: 6,
        magic: 5,
        summon: 4,
        control: 6,
    };
    for (const profession of Object.keys(expectedProfessionCounts)) {
        if (professionCounts[profession] !== expectedProfessionCounts[profession]) {
            throw new Error(`General profession ${profession} must contain ${expectedProfessionCounts[profession]} entries, received ${professionCounts[profession]}`);
        }
    }
    const declaredIds = Object.values(exports.GENERAL_IDS);
    ...
    const lockedIdentityIds = {
        '后羿': exports.GENERAL_IDS.HOUYI,
        '嫦娥': exports.GENERAL_IDS.CHANG_E,
        '杨戬': exports.GENERAL_IDS.YANGJIAN,
        '哪吒': exports.GENERAL_IDS.NAZHA,
        '李靖': exports.GENERAL_IDS.LIJING,
        '孙悟空': exports.GENERAL_IDS.SUNWUKONG,
    };
...
exports.GENERAL_ROSTER_BY_ID = new Map(exports.GENERAL_ROSTER.map((entry) => [entry.generalId, entry]));
function getGeneralRosterEntry(generalId) {
    return exports.GENERAL_ROSTER_BY_ID.get(generalId) ?? null;
}
